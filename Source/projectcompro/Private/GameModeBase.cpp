...
AGameModeBase_C_::AGameModeBase_C_(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	(((FBoolProperty*)Local_1)->SetPropertyValue_InContainer((DefaultSceneRoot), false, 0));
	PlayerControllerClass = AWorldController_C_::StaticClass();
	DefaultPawnClass = AWorld_C_::StaticClass();
...
void AGameModeBase_C_::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AGameModeBase_C_::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AWorldController_C_::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AGameModeBase_C_::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}

PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AGameModeBase_C_::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{24, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  
		{25, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)}, 
		{26, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)}, 
		{27, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)}, 
		{28, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)}, 
		{29, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)}, 
		{1, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  
		{30, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)}, 
		...
		{11, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)}, 
		...
		{31, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)}, 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AGameModeBase_C_
{
	FRegisterHelper__AGameModeBase_C_()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/GameModeBase"), &AGameModeBase_C_::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AGameModeBase_C_ Instance;
};


FRegisterHelper__AGameModeBase_C_ FRegisterHelper__AGameModeBase_C_::Instance;
