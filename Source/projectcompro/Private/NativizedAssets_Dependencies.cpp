...
namespace
{
	...
	FBlueprintDependencyObjectRef(TEXT("/Game/Blueprints"), TEXT("CharacterController"), TEXT("CharacterController_C"), TEXT("/Script/CoreUObject"), TEXT("DynamicClass"), TEXT("")),
	...
	FBlueprintDependencyObjectRef(TEXT("/Game/Blueprints"), TEXT("WorldController"), TEXT("WorldController_C"), TEXT("/Script/CoreUObject"), TEXT("DynamicClass"), TEXT("")),
	};
}
