...
ACharacter::ACharacter(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	Collider->CreationMethod = EComponentCreationMethod::Native;

	auto& ColliderCapsule_Height = (*(AccessPrivateProperty<float >((Collider), UCapsuleComponent::__PPO__CapsuleHalfHeight() )));
	ColliderCapsule_Height = 34.0f;

	auto& ColliderCapsule_Radius = (*(AccessPrivateProperty<float >((Collider), UCapsuleComponent::__PPO__CapsuleRadius() )));
	ColliderCapsule_Radius = 12.0f;
	...
	PlayerFlipbook->bCastShadowAsTwoSided = true;
